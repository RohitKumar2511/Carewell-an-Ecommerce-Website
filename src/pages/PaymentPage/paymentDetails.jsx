...
import LTNLOGO from "../../assets/LTNLOGO.png"
    ...
    return (
      <Box>
        <Button
          ...
          ml='15px'
        >
          Pay Rs. {(totalMRP - discount).toFixed(2)}
        </Button>
      </Box>
    )
  }
          ...
          <SimpleGrid columns={1} w={{ md: '100%' }} mr="20px" padding={{ base: "20px", lg: "0px" }}>
            <Box   >
              ...
              <Box padding='10px' mb='60px' id='boxshadow'>
                <Text fontSize='12px' color='rgba(21,27,57,.6)' mb='10px'>Crypto Wallet</Text>
                <Flex justifyContent="space-between" ml='15px'>
                  <Flex align='center'>
                    <Image h='40px' mr='15px' src={LTNLOGO} alt='img' />
